...
for k=krange,
    ...
    for m=1:simreps,
        ...
        [idx1]=kmeans(CMAT(ss1,:),k);%,'Start','sample','Replicates',5);
        [idx2]=kmeans(CMAT(ss2,:),k);%,'Start','sample','Replicates',5);
%         [idx1]=spectralcluster(CMAT(ss1,:),k);kmeans
%         [idx2]=spectralcluster(CMAT(ss2,:),k);
